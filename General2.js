...
export function readGeneral2Data(workbook, selectSerial) {
  // const release = await lockfile.lock(file, {         // <- trả về hàm "release()"
  //     retries: {retries: 5, factor: 1.5}              //    tối đa 5 lần, back‑off 1.5×
  // });
    ...
    // console.log("[totalCommon, totalNew, totalDecrease] =", [totalCommon, totalNew, totalDecrease])
